    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_status', models.CharField(choices=[('C', 'تکمیل شده'), ('I', 'درحال برگزاری'), ('S', 'شروع به زودی')], default='S', max_length=1)),
                ('status', models.CharField(choices=[('DR', 'پیش نویس'), ('PD', 'منتشر شده')], default='DR', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner', models.ImageField(blank=True, null=True, upload_to='Courses/SubCategory_banners/', verbose_name='بنر زیر دسته بندی')),
