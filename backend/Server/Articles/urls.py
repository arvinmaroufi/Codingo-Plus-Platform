...
from .router import MainCategoryRouter, SubCategoryRouter, TagRouter, AuthorRouter, ArticleContentRouter, ArticleRouter
...
urlpatterns = [
    ...
    path('articles/', include(article_router.get_urls())),
